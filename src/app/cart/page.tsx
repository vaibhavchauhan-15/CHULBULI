        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6 md:mb-10">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-playfair font-bold mb-2 md:mb-3 text-[#5A3E2B]">
                  Shopping Cart
                </h1>
                <p className="text-sm md:text-base lg:text-lg text-[#5A3E2B]/70 font-light">
              ...
              {unavailableItems.length > 0 && (
                <button
                  ...
                  className="bg-red-500 hover:bg-red-600 text-white px-3 md:px-4 py-2 rounded-lg transition-colors flex items-center gap-2 text-xs md:text-sm"
                >
