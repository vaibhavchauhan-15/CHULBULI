  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-champagne via-pearl to-champagne py-16">
      ...
      <div className="max-w-4xl mx-auto px-8 md:px-16">
        ...
        {/* Detailed Terms */}
        <div className="bg-white/70 backdrop-blur-sm rounded-lg p-8 md:p-12 shadow-luxury border border-rosegold/20 space-y-6">
          
          <section>
            <div className="space-y-4 text-warmbrown/80 text-sm md:text-base leading-relaxed">
          ...
          <section>
            <div className="space-y-4 text-warmbrown/80 text-sm md:text-base leading-relaxed">
              <p>The Platform is owned by <strong className="text-warmbrown">CHULBULI JEWELS</strong>, a company incorporated under the Companies Act, 1956 with its registered office at C 1004 Block C Sahitya Green Madhavpura Bapod Vadodara Gujarat 390019 India (hereinafter referred to as &apos;Platform Owner&apos;, &apos;we&apos;, &apos;us&apos;, &apos;our&apos;).</p>
            </div>
          </section>
          ...
          <section>
            <div className="space-y-4 text-warmbrown/80 text-sm md:text-base leading-relaxed">
              ...
              <p><strong className="text-warmbrown">These Terms of Use can be modified at any time without assigning any reason. It is your responsibility to periodically review these Terms of Use to stay informed of updates.</strong></p>
          ...
          <section>
            <h2 className="font-playfair text-xl text-warmbrown mb-4">Terms of Use</h2>
            <p className="text-warmbrown/80 text-sm md:text-base leading-relaxed mb-4">The use of Platform and/or availing of our Services is subject to the following Terms of Use:</p>
