...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#5A3E2B]/60 backdrop-blur-sm mt-16 md:mt-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-16 py-8 md:py-12 relative z-10">
  ...
  <p className="text-pearl/80 text-[10px] md:text-xs mb-3 md:mb-4 tracking-wider">FOLLOW US</p>
  ...
  <div className="flex gap-2.5 md:gap-3 justify-center md:justify-start">
    <a
      ...
      className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-rosegold/10 border border-rosegold/30 flex items-center justify-center hover:bg-rosegold hover:border-rosegold hover:scale-110 hover:shadow-lg hover:shadow-rosegold/30 transition-all duration-500 group active:scale-95"
    >
    ...
    >
      <FaWhatsapp className="w-3.5 h-3.5 md:w-4 md:h-4 text-softgold group-hover:text-pearl group-hover:scale-110 transition-all" />
        ...
        <div className="mt-10 md:mt-16 pt-6 md:pt-8 border-t border-pearl/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4">
            ...
            <div className="flex gap-4 md:gap-6 text-[10px] md:text-xs text-pearl/70">
